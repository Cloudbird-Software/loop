...
| [C-008](./C-008.md) | 造 verify.required=true 卡跑通 impl→verify→merge 闭环 | critical | [C-004, C-005, C-007] | false | pending | P1 |
| [C-009](./C-009.md) | 8 个 gate 接进 product-x branch ruleset | standard | [C-007] | false | pending | P1 |
| [C-010](./C-010.md) | 起草 CHARTER.md（G/N/Q） | standard | — | true | pending | P2 |
...
|---|---|---|---|---|---|
| _（暂无，验证卡 FAIL 时由验证 AI 新建并登记在此）_ | | | | | |
